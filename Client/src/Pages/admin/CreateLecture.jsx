...
const CreateLecture = () => {
    ...
    useEffect(()=>{
        ...
        getLectures();
    },[lecture, dispatch, params?.courseId])
    // [lecture]
  ...
  return (
    <div className='p-4 md:p-10 md:pr-20 h-screen'>
        ...
        <p>Can create lectures in here...</p>
        <div className='mt-10 space-y-5'>
            ...
            <div className='flex gap-2'>
                ...
                <Button disabled={loading} onClick={createLectureHandler} className="bg-gray-600 hover:bg-gray-800">
                    {
        ...
        <div className='mt-10'>
            {
                //lecture?.map
                //edited by me to this "lecture?.map" to "{Array.isArray(lecture) && lecture.map"
